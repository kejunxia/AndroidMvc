    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_poke_registry_inject10).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    graph.register(Service0.class, Service0Impl.class);
                    graph.register(Service1.class, Service1Impl.class);
                    graph.register(Service2.class, Service2Impl.class);
                    graph.register(Service3.class, Service3Impl.class);
                    graph.register(Service4.class, Service4Impl.class);
                    graph.register(Service5.class, Service5Impl.class);
                    graph.register(Service6.class, Service6Impl.class);
                    graph.register(Service7.class, Service7Impl.class);
                    graph.register(Service8.class, Service8Impl.class);
                    graph.register(Service9.class, Service9Impl.class);

                    graph.inject(container, Inject.class);
        ...
        findViewById(R.id.button_poke_registry_inject10x10).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SimpleGraph graph = new SimpleGraph();
                try {
                    graph.register(Controller0.class, Controller0Impl.class);
                    graph.register(Controller1.class, Controller1Impl.class);
                    graph.register(Controller2.class, Controller2Impl.class);
                    graph.register(Controller3.class, Controller3Impl.class);
                    graph.register(Controller4.class, Controller4Impl.class);
                    graph.register(Controller5.class, Controller5Impl.class);
                    graph.register(Controller6.class, Controller6Impl.class);
                    graph.register(Controller7.class, Controller7Impl.class);
                    graph.register(Controller8.class, Controller8Impl.class);
                    graph.register(Controller9.class, Controller9Impl.class);
                    graph.register(Service0.class, Service0Impl.class);
                    graph.register(Service1.class, Service1Impl.class);
                    graph.register(Service2.class, Service2Impl.class);
                    graph.register(Service3.class, Service3Impl.class);
