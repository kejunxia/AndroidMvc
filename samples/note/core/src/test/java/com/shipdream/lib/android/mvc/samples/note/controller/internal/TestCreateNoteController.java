...
public class TestCreateNoteController extends TestControllerBase<NoteCreateController> {
    ...
    public static class TestComp extends Component {
        TestCreateNoteController testNoteController;
    ...
    @Override
    protected NoteCreateController createTestingController() {
        return new NoteCreateControllerImpl();
    }
//
//    @Test
