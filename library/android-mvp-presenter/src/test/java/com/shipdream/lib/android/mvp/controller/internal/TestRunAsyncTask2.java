...
public class TestRunAsyncTask2 extends BaseTest {
    class EventMonitor {
        public void onEvent(MyControllerImpl2.ResourceLoadStarted event) {}
        public void onEvent(MyControllerImpl2.ResourceLoaded event) {}
        public void onEvent(MyControllerImpl2.ResourceLoadFailed event) {}
        public void onEvent(MyControllerImpl2.ResourceLoadCanceled event) {}
    }

    private MyControllerImpl2 controller;
    private EventMonitor eventMonitor;
    private static final long WAIT_DURATION = MyControllerImpl2.LONG_TASK_DURATION + 100;
    ...
    public void setUp() throws Exception {
        ...
        controller = new MyControllerImpl2();
    ...
    public void should_be_able_to_run_async_task_successfully() throws Exception {
        ...
        verify(eventMonitor, times(1)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadStarted.class).capture());
        ArgumentCaptor<MyControllerImpl2.ResourceLoaded> eventResourceLoaded
                = ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoaded.class);
        verify(eventMonitor, times(1)).onEvent(eventResourceLoaded.capture());

        ArgumentCaptor<MyControllerImpl2.ResourceLoadFailed> eventResourceLoadFailed
                = ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadFailed.class);
        verify(eventMonitor, times(0)).onEvent(eventResourceLoadFailed.capture());

        ArgumentCaptor<MyControllerImpl2.ResourceLoadCanceled> eventResourceLoadCanceled
                = ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadCanceled.class);
    ...
    public void should_be_able_to_cancel_task_before_it_runs() throws Exception {
        ...
        ArgumentCaptor<MyControllerImpl2.ResourceLoadStarted> eventResourceLoadStarted
                = ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadStarted.class);
    ...
    public void should_be_able_to_interrupted_task_while_it_is_running() throws Exception {
        ...
        verify(eventMonitor, times(1)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadStarted.class).capture());
        verify(eventMonitor, times(0)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoaded.class).capture());
        verify(eventMonitor, times(0)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadFailed.class).capture());
    ...
    public void cancel_done_task_should_has_no_effect() throws Exception {
        ...
        verify(eventMonitor, times(1)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadStarted.class).capture());
        verify(eventMonitor, times(1)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoaded.class).capture());
        verify(eventMonitor, times(0)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadFailed.class).capture());
        verify(eventMonitor, times(0)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadCanceled.class).capture());
    ...
    public void cancel_without_interrupted_flag_on_running_task_should_has_no_effect() throws Exception {
        ...
        verify(eventMonitor, times(1)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadStarted.class).capture());
        verify(eventMonitor, times(0)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoaded.class).capture());
        verify(eventMonitor, times(1)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadFailed.class).capture());
        verify(eventMonitor, times(0)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadCanceled.class).capture());
    ...
    public void cancel_cancelled_task_should_has_no_effect() throws Exception {
        ...
        ArgumentCaptor<MyControllerImpl2.ResourceLoadStarted> loaded = ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadStarted.class);
        verify(eventMonitor, times(1)).onEvent(loaded.capture());
        Assert.assertTrue(t1 == loaded.getValue().getTask());

        ArgumentCaptor<MyControllerImpl2.ResourceLoaded> done = ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoaded.class);
        verify(eventMonitor, times(1)).onEvent(done.capture());
        Assert.assertTrue(t1 == done.getValue().getTask());

        verify(eventMonitor, times(0)).onEvent(ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadFailed.class).capture());

        ArgumentCaptor<MyControllerImpl2.ResourceLoadCanceled> cancelEvent = ArgumentCaptor.forClass(MyControllerImpl2.ResourceLoadCanceled.class);
