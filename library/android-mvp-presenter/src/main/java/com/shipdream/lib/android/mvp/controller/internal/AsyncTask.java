 ...
 * {@link BaseControllerImpl#runAsyncTask(Object, ExecutorService, AsyncTask)}
 * or {@link BaseControllerImpl#runAsyncTask(Object, ExecutorService, AsyncTask, AsyncExceptionHandler)}
 *
...
public abstract class AsyncTask {
    ...
    /**
     * Change the {@link State} of this {@link AsyncTask} to {@link State#CANCELED}
     * only when its current {@link State} is {@link State#NOT_STARTED} or
     ...
     * {@link State} is {@link State#NOT_STARTED} or {@link State#RUNNING}, otherwise
     * returns <b>FALSE</b>
     */
